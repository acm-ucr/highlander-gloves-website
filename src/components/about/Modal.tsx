...
const Modal = ({ answer, onClose }: ModalProps) => {
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-70 md:translate-x-0">
      <div className="absolute left-1/2 top-1/2 w-5/6 -translate-x-1/2 -translate-y-1/2 border-4 border-hlg-red-200 bg-hlg-red-300 p-12 2xl:p-24">
        <div
