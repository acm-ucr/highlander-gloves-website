const AboutUs = () => {
  return (
    <div className="mt-5 flex w-3/4 flex-col items-center justify-center gap-10 text-xs leading-normal md:mt-10 md:text-3xl md:2xl:w-2/3">
      <p className="font-anek-tekygu animate-fade-down indent-4 duration-300 md:indent-16 md:font-archivo-black">
      ...
      <p className="font-anek-tekgyu animate-fade-up indent-4 leading-normal duration-300 md:indent-16 md:font-archivo-black">
      ...
      <iframe
        ...
        className="aspect-video w-3/4 animate-jump-in rounded border-[3px] shadow-[22px_22px_0px_0px_#441212] duration-200 md:w-1/2"
      />
    </div>
  );
};
