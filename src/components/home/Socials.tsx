...
const Socials = () => {
  return (
    <div className="relative mb-10 flex w-full flex-col items-center justify-center text-3xl">
      ...
      <FaDiscord className="absolute left-[13.5%] top-[52%] duration-200 hover:scale-[110%] hover:cursor-pointer xl:left-[13.5%] xl:top-[45%] xl:text-8xl 2xl:left-[14%] 2xl:top-[46%] 2xl:text-9xl" />
      <FaTiktok className="absolute bottom-[7%] left-[32.5%] duration-200 hover:scale-[110%] hover:cursor-pointer xl:bottom-[7%] xl:left-[31.5%] xl:text-8xl 2xl:bottom-[7%] 2xl:left-[32%] 2xl:text-9xl" />
